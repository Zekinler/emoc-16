...
pub enum RegisterName {
    ...
    MemoryAddressWH,    // The wide address being read from/written to in memory (High)
    MemoryAddressWL,    // The wide address being read from/written to in memory (Low)
    MemoryAddressH,     // The thin address being read from/written to in memory (High)
    MemoryAddressL,     // The thin address being read from/written to in memory (Low)
    ...
    ProgramCounterWH,   // The wide address of the current place in execution (High)
    ProgramCounterWL,   // The wide address of the current place in execution (Low)
    ProgramCounterH,    // The thin address of the current place in execution (High)
    ProgramCounterL,    // The thin address of the current place in execution (Low)
    ...
    StackPointerWH,     // The wide address of the current place in the stack (High)
    StackPointerWL,     // The wide address of the current place in the stack (Low)
    StackPointerH,      // The thin address of the current place in the stack (High)
    StackPointerL,      // The thin address of the current place in the stack (Low)
    BasePointerWH,      // The wide address of the base of the stack (High)
    BasePointerWL,      // The wide address of the base of the stack (Low)
    BasePointerH,       // The thin address of the base of the stack (High)
    BasePointerL,       // The thin address of the base of the stack (Low)
    IndexAH,            // A wide address pointer used for memory-related operations, primarily for addressing data (High)
    IndexAL,            // A wide address pointer used for memory-related operations, primarily for addressing data (Low)
    IndexBH,            // A wide address pointer used for memory-related operations, primarily for addressing code (High)
    IndexBL,            // A wide address pointer used for memory-related operations, primarily for addressing code (Low)
